...
//     * @return this
//     */
//    public Photo download(int maxWidth, int maxHeight) {
//        image = place.getClient().downloadPhoto(this,maxWidth,maxHeight);
//        return this;
//    }
    
    /**
     * Downloads the photo and caches into inputStream
     *
     * @param maxWidth    of photo
     * @param maxHeight   of photo
     * @param extraParams to append to request url
