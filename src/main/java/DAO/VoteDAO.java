...
public class VoteDAO {
    private static String InsertVotePropToPlace = "INSERT INTO UserVotes (userId, placeId, propId, vote, fTimestamp) Values(?,?,?,?,?)";

    public static void insertVoteAnswer(int propId, String placeId, int voteValue, String username) throws SQLException {
