...
-- -----------------------------------------------------
-- Table `dbmysql11`.`users_check_in`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbmysql11`.`users_check_in` (
  `user_id` VARCHAR(40) NOT NULL,
...
-- -----------------------------------------------------
-- Table `dbmysql11`.`users_search_props_history`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `dbmysql11`.`users_search_props_history` (
  `user_id` VARCHAR(40) NOT NULL,
